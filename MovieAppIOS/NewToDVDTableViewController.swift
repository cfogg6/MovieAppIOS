//
//  NewToDVDTableViewController.swift
//  MovieAppIOS
//
...
class NewToDVDTableViewController: UITableViewController {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        navigationItem.title = "New To DVD"

        let postEndpoint: String = "http://api.rottentomatoes.com/api/public/v1.0/lists/dvds/new_releases.json?apikey=yedukp76ffytfuy24zsqk7f5"
